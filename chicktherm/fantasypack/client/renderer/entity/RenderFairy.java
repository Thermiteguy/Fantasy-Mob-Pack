package chicktherm.fantasypack.client.renderer.entity;
...
public class RenderFairy extends RenderLiving
{
    ...
    public void renderFairy(EntityFairy par1EntityFairy, double par2, double par4, double par6, float par8, float par9)
    {
